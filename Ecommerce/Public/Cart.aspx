<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cart.aspx.cs" Inherits="Ecommerce.Public.Cart" %>
            ...
            <div class="row g-0 vh-lg-100">
                <div class="col-12 col-lg-7 pt-5 pt-lg-10">
                    <div class="pe-lg-5">
                        ...
                        <div class="mt-5">
                            <h3 class="fs-5 fw-bolder mb-0 border-bottom pb-4">Sizin Sepetiniz</h3>
                            <div class="table-responsive">
                                <table class="table align-middle">
                                    <tbody class="border-0">
                                        ...
                                        <asp:Literal ID="literalCartListeleme" runat="server"></asp:Literal>
                                        <!-- / Cart Item-->
                                    </tbody>
                                </table>
                            </div>
                    ...
                    <div class="p-4 py-lg-0 pe-lg-0 ps-lg-5">
                        <div class="pb-4 border-bottom">
                            <div class="d-flex flex-column flex-md-row justify-content-md-between mb-4 mb-md-2">
                                ...
                                <p class="m-0 fs-5 fw-bold" id="lbl_CartTotal" runat="server"></p>
                            </div>
                        </div>
                        <a href="./checkout-payment.aspx" class="btn btn-dark w-100 text-center" role="button">Ödeme işlemine ilerleyin</a>
                    </div>
                </div>
            </div>
        </div>
